...
async function main() {
  ...
  // Send 0.01 GSUp to all addresses
  for (let i = 0; i < 50; i++) {
  ...
  //manipulate mkr contract, give test address 250K GSUp
  ...
  //console.log(`test account now has ${ethers.utils.formatUnits(mkrBalance)} GSUp`);
